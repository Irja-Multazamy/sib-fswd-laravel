...
<html lang="en">
    <head>
        ...
        <title>SenaShop E-Commerce</title>
        <!-- Favicon-->
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="#!">SenaShop</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="d-flex">
                        ...
                        <a href="{{ route('dashboard') }}" class="btn btn-outline-dark ms-1" type="submit">
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                <img src="https://picsum.photos/1000/300.webp?random=3" class="d-block w-100" alt="...">
                </div>
            </div>
